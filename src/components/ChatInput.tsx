...
export function ChatInput({ onSend, disabled }: ChatInputProps) {
  ...
  return (
    <div className="border-t border-gray-700 bg-gray-900/80 backdrop-blur-md px-4 py-3">
      <div className="max-w-4xl mx-auto flex items-end gap-3">
        ...
        <textarea
          ...
          disabled={disabled}
          rows={1}
          className={`flex-1 resize-none rounded-xl px-4 py-3 text-sm text-gray-100 bg-gray-800/80 border border-gray-700 placeholder-gray-500 
